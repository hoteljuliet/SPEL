...
public class Pipeline implements Serializable {
    ...
    public static final String[] defaultPredicatePackages = {"com.github.hoteljuliet.spel.predicates"};
    public static final String[] defaultStatementPackages = {"com.github.hoteljuliet.spel.statements"};
