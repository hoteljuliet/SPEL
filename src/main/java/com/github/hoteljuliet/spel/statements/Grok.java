...
import com.github.hoteljuliet.spel.grok.GrokCompiler;
import com.github.hoteljuliet.spel.grok.Match;
...
public class Grok extends StepStatement implements Serializable {
    ...
    private final List<com.github.hoteljuliet.spel.grok.Grok> groks;
    ...
    public Grok(@JsonProperty(value = "value", required = true) String value,
        ...
        for (String pattern : patterns) {
            com.github.hoteljuliet.spel.grok.Grok grok = GrokCompiler.getInstance().compile(pattern, onlyNamed);
            groks.add(grok);
        }
    }
    ...
    public Optional<Boolean> doExecute(Context context) throws Exception {
        ...
        for (com.github.hoteljuliet.spel.grok.Grok grok : groks) {
